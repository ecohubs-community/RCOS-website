...
1. Start with **Layer 0 — Identity & Scope**. It is the foundation everything else stands on.
2. Work through the layers in order. Each one references and builds on the previous.
3. Fill in the placeholders as a group, using the rationale and instructions to keep the conversation honest.
4. Treat the result as a **living constitution** — versioned, reviewable, and amendable through the process you define.
